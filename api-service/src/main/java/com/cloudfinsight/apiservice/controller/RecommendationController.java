...
public class RecommendationController {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete a recommendation (admin only)",
        description = "Hard-deletes a recommendation row. Restricted to the 'admin' realm role; " +
                      "a 'viewer'-role token receives 403.")
